...
// NOTE:
// - cap : returns the capacity of collections like Array, Slice etc.
// Read more here: https://golang.org/pkg/builtin/#cap
// - length(len) discards empty strings i.e. "" but capacity(cap) counts those in as well check line #20 & #21
